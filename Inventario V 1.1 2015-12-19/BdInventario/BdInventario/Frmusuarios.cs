...
namespace BdInventario
{
    public partial class Frmusuarios : Plantiparam
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'bdinventarioDataSetTipousuario.tipo_usuario' Puede moverla o quitarla según sea necesario.
            this.tipo_usuarioTableAdapter.Fill(this.bdinventarioDataSetTipousuario.tipo_usuario);
            autonumericoid();         
        }
