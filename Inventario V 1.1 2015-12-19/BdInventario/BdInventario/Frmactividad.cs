...
namespace BdInventario
{
    public partial class Frmactividad : Plantiparam
    {
        ...
        void cargadatoinicial()
        {
            //try
            //{
            //    MySqlCommand comando = new MySqlCommand("Select cli.IdActividadUsuario, cli.Nombre_Usuario, cli.Contrasena, tpu.Nombre_Tipo_Usuario from usuarios cli, tipo_usuario tpu where 1 and cli.Tipo_Usuario_ID=tpu.ID", miconexion);
            //    miconexion.Open();
            //    MySqlDataReader leer = comando.ExecuteReader();
            //    if (leer.Read())
            //    {
