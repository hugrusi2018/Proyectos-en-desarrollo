...
namespace BdInventario
{
    public partial class Frmimpuestos : Plantiparam
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'bdinventarioDataSetImpuetos.impuestos' Puede moverla o quitarla según sea necesario.
            this.impuestosTableAdapter.Fill(this.bdinventarioDataSetImpuetos.impuestos);
            autonumericoid();
        }
        void autonumericoid()
        {
